...
class batch_generator_test_fmri(Sequence):
    ...
    """
    def __init__(self,Y,labels, batch_size=8, frac =3,ignore_labels = None):
        self.Y = Y
        self.labels = labels
        self.frac = frac
...
class batch_generator_encdec(Sequence):
    ...
    def __init__(self, X, Y, Y_test, test_labels, batch_paired = 1, batch_unpaired = 1, max_shift_enc = 5, img_len = config_file.image_size
